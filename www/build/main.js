...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/benepik/Desktop/currently working/ionic 2/test/customComponent/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n<div *ngFor="let udetails of data">\n    <custom userimage={{udetails.userImage}} name={{udetails.name}} title={{udetails.title}} content={{udetails.content}}></custom>\n</div>\n   \n\n</ion-content>\n'/*ion-inline-end:"/home/benepik/Desktop/currently working/ionic 2/test/customComponent/src/pages/home/home.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/home/benepik/Desktop/currently working/ionic 2/test/customComponent/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/benepik/Desktop/currently working/ionic 2/test/customComponent/src/pages/list/list.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_custom_custom__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_magic_ball_magic_ball__ = __webpack_require__(270);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_8__components_custom_custom__["a" /* CustomComponent */],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__providers_magic_ball_magic_ball__["a" /* MagicBallProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/benepik/Desktop/currently working/ionic 2/test/customComponent/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/home/benepik/Desktop/currently working/ionic 2/test/customComponent/src/app/app.html"*/
        }),
...
var CustomComponent = /** @class */ (function () {
    ...
    CustomComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'custom',template:/*ion-inline-start:"/home/benepik/Desktop/currently working/ionic 2/test/customComponent/src/components/custom/custom.html"*/'<!-- Generated template for the CustomComponent component -->\n<div>\n    <ion-card>\n        \n          <ion-item>\n            <ion-avatar item-start>\n              <img src="{{userImage}}">\n            </ion-avatar>\n            <h2>{{name}}</h2>\n            <p>{{title}}</p>\n          </ion-item>\n        \n          <!-- <img src="img/advance-card-bttf.png"> -->\n        \n          <ion-card-content>\n            <p>{{Content}}</p>\n          </ion-card-content>\n        \n          <ion-row>\n            <ion-col>\n              <button ion-button icon-start clear small>\n                <ion-icon name="thumbs-up"></ion-icon>\n                <div>12 Likes</div>\n              </button>\n            </ion-col>\n            <ion-col>\n              <button ion-button icon-start clear small>\n                <ion-icon name="text"></ion-icon>\n                <div>4 Comments</div>\n              </button>\n            </ion-col>\n            <ion-col center text-center>\n              <ion-note>\n                11h ago\n              </ion-note>\n            </ion-col>\n          </ion-row>\n        \n        </ion-card>\n</div>\n'/*ion-inline-end:"/home/benepik/Desktop/currently working/ionic 2/test/customComponent/src/components/custom/custom.html"*/
        }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MagicBallProvider; });
...
/*
  ...
  and Angular DI.
*/
var MagicBallProvider = /** @class */ (function () {
    function MagicBallProvider(http) {
        this.http = http;
        console.log('Hello MagicBallProvider Provider');
    }
    MagicBallProvider = __decorate([
...
//# sourceMappingURL=magic-ball.js.map
